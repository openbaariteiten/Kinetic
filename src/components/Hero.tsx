      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-xl text-ink/70 max-w-lg mb-10 leading-relaxed font-medium">
            {isPrivate 
              ? "Een duurzaam huis hoeft niet ingewikkeld te zijn. OMNI brengt de expertise van de industriële sector naar uw voordeur. Wij nemen het beheer van advies tot installatie."
              : "Wij installeren niet alleen; wij beheren. OMNI is de full-service partner die de complexiteit van de energietransitie uit handen neemt voor bedrijven."}
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-kinetic text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-kinetic-dark transition-all group shadow-lg shadow-kinetic/20">
              {isPrivate ? "OMNI voor uw woning" : "Ontdek onze zakelijke oplossingen"}
